const review_msg = document.getElementById("msg");
const review_name = document.getElementById("exampleFormControlInput1");
const review_pwd = document.getElementById("exampleFormControlInput2");
